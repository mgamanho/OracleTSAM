...
#
if ! JAVA_HOME=/usr/java/default ./Disk1/install/runInstaller.sh -invPtrLoc /home/oracle/Downloads/oraInst.loc -responseFile $CURDIR/tuxedo12.2.2.rsp -silent -waitforcompletion; then
